...
priors_hierarchical_2 <- c(
  ...
  set_prior("lkj(2)", class = "cor"), # Keeping the LKJ prior for correlation matrix reasonable
  set_prior("normal(0, 2.5)", class = "sd"), # Stronger prior for the standard deviation of group-level effects
  set_prior("normal(0, 2.5)", class = "Intercept", group = "country") # Strong prior for the random intercepts for country
)
